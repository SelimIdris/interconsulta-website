        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 w-full relative z-10 flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-5/12 flex flex-col">
            ...
            <p className="font-sans text-lg text-textDark/70 leading-relaxed mb-12 max-w-md">
              Haben Sie Fragen zur Revision oder wünschen Sie ein erstes Kennenlernen? Wir stehen Ihnen gerne zur Verfügung.
            </p>

            <div className="bg-background rounded-[2rem] p-8 md:p-10 flex flex-col gap-8 flex-1 shadow-sm border border-textDark/5">
              <div>
                <h3 className="font-sans font-bold text-textDark text-xl mb-4">Inter Consulta Audit AG</h3>
          ...
          <div className="w-full lg:w-7/12">
            <form className="bg-sea text-white rounded-[2rem] p-8 md:p-12 lg:p-16 h-full flex flex-col justify-center gap-8 shadow-premium" onSubmit={(e) => e.preventDefault()}>
              <h3 className="font-sans font-bold text-3xl mb-8">Ihre Anfrage</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col gap-3">
                  <label className="font-mono text-[11px] text-white/70 uppercase tracking-widest font-medium">Name</label>
                  <input type="text" className="bg-transparent border-b-2 border-white/20 focus:border-sandstone outline-none py-2 font-sans text-lg transition-colors placeholder:text-white/30" placeholder="Ihr Vor- & Nachname" />
                </div>
                <div className="flex flex-col gap-3">
                  <label className="font-mono text-[11px] text-white/70 uppercase tracking-widest font-medium">E-Mail</label>
                  <input type="email" className="bg-transparent border-b-2 border-white/20 focus:border-sandstone outline-none py-2 font-sans text-lg transition-colors placeholder:text-white/30" placeholder="ihre.email@firma.ch" />
                </div>
              </div>

              <div className="flex flex-col gap-3">
                <label className="font-mono text-[11px] text-white/70 uppercase tracking-widest font-medium">Telefonnummer</label>
                <input type="tel" className="bg-transparent border-b-2 border-white/20 focus:border-sandstone outline-none py-2 font-sans text-lg transition-colors placeholder:text-white/30" placeholder="+41 00 000 00 00" />
              </div>

              <div className="flex flex-col gap-3 mb-4">
                <label className="font-mono text-[11px] text-white/70 uppercase tracking-widest font-medium">Ihr Anliegen</label>
                <textarea rows="4" className="bg-transparent border-b-2 border-white/20 focus:border-sandstone outline-none py-2 font-sans text-lg transition-colors resize-none placeholder:text-white/30" placeholder="Wie können wir Sie unterstützen?"></textarea>
              </div>
